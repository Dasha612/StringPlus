...
START_TEST(test5_s21_sprintf_str_precision) {
  ...
  int s21_res6 =
      s21_sprintf(s21_buff, "|%.1s|%.2s|%.3s|", "abc", "xyz", "12345");
...
START_TEST(test11_s21_sprintf_dec_width_precision) {
  ...
  int s21_res3 =
      s21_sprintf(s21_buff, "|%10.6d|%15.3d|%20.15d|", -777, 42, 123);
...
START_TEST(test14_s21_sprintf_unsigned_precision) {
  ...
  int s21_res3 =
      s21_sprintf(s21_buff, "|%.0u|%.0u|%.15u|%.1u|", 0u, 42u, 0u, 0u);
...
START_TEST(test15_s21_sprintf_unsigned_width_precision) {
  ...
  int s21_res4 =
      s21_sprintf(s21_buff, "|%1.1u|%2.2u|%3.3u|%4.4u", 1111u, 111u, 11u, 1u);
...
START_TEST(test16_s21_sprintf_unsigned_flags) {
  ...
  int s21_res3 =
      s21_sprintf(s21_buff, "|%-12u|%-8u|%-5u|", 111111u, 2222u, 333u);
...
START_TEST(test17_s21_sprintf_modifier) {
  ...
  int s21_res2 =
      s21_sprintf(s21_buff, "|%hd|%hu|", (short)-1, (unsigned short)0);
  ...
  int s21_res5 =
      s21_sprintf(s21_buff, "|%hd|%ld|%hu|%lu", s_val, l_val, us_val, ul_val);
  int res5 = sprintf(buff, "|%hd|%ld|%hu|%lu", s_val, l_val, us_val, ul_val);
  ck_assert_int_eq(s21_res5, res5);
  ck_assert_str_eq(s21_buff, buff);

  int s21_res6 = s21_sprintf(s21_buff, "|%5hd|%5ld|%5hu|%5lu|", s_val, l_val,
                             us_val, ul_val);
  int res6 =
      sprintf(buff, "|%5hd|%5ld|%5hu|%5lu|", s_val, l_val, us_val, ul_val);
  ck_assert_int_eq(s21_res6, res6);
  ck_assert_str_eq(s21_buff, buff);

  int s21_res7 = s21_sprintf(s21_buff, "|%.6hd|%.10ld|%.8hu|%.12lu|", s_val,
                             l_val, us_val, ul_val);
  int res7 = sprintf(buff, "|%.6hd|%.10ld|%.8hu|%.12lu|", s_val, l_val, us_val,
                     ul_val);
  ck_assert_int_eq(s21_res7, res7);
  ck_assert_str_eq(s21_buff, buff);
...
START_TEST(test19_s21_sprintf_float) {
  ...
  int s21_res2 =
      s21_sprintf(s21_buff, "|%f|%f|%f|", 0.0f, 0.000001f, -0.0000001f);
  int res2 = sprintf(buff, "|%f|%f|%f|", 0.0f, 0.000001f, -0.0000001f);
  ck_assert_int_eq(s21_res2, res2);
  ck_assert_str_eq(s21_buff, buff);

  int s21_res3 = s21_sprintf(s21_buff, "|%f|%f|%f|%f|", 12345678.0f, 1234.5678f,
                             -12345678.0f, -1234.5678f);
  int res3 = sprintf(buff, "|%f|%f|%f|%f|", 12345678.0f, 1234.5678f,
                     -12345678.0f, -1234.5678f);
  ck_assert_int_eq(s21_res3, res3);
  ck_assert_str_eq(s21_buff, buff);
}
...
START_TEST(test20_s21_sprintf_float_width) {
  ...
  int s21_res2 = s21_sprintf(s21_buff, "|%5f|%9f|%15f|", 12345.678f, 123.456f,
                             987654.321f);
...
START_TEST(test21_s21_sprintf_float_precision) {
  ...
  int s21_res2 =
      s21_sprintf(s21_buff, "|%.1f|%.3f|%.10f|", 3.14f, 3.14159f, 1.23f);
  int res2 = sprintf(buff, "|%.1f|%.3f|%.10f|", 3.14f, 3.14159f, 1.23f);
  ck_assert_int_eq(s21_res2, res2);
  ck_assert_str_eq(s21_buff, buff);

  int s21_res3 =
      s21_sprintf(s21_buff, "|%.6f|%.8f|%.2f|", 2.5f, 0.0000001f, 12345.678f);
...
START_TEST(test22_s21_sprintf_float_width_precision) {
  ...
  int s21_res1 =
      s21_sprintf(s21_buff, "|%10.2f|%10.5f|%5.6f|", 3.14f, 2.5f, 1.234567f);
  int res1 = sprintf(buff, "|%10.2f|%10.5f|%5.6f|", 3.14f, 2.5f, 1.234567f);
  ck_assert_int_eq(s21_res1, res1);
  ck_assert_str_eq(s21_buff, buff);

  int s21_res2 = s21_sprintf(s21_buff, "|%8.0f|%10.3f|%15.1f|", 42.11f,
                             -1.2345f, 9876.543f);
  int res2 =
      sprintf(buff, "|%8.0f|%10.3f|%15.1f|", 42.11f, -1.2345f, 9876.543f);
  ck_assert_int_eq(s21_res2, res2);
  ck_assert_str_eq(s21_buff, buff);

  int s21_res3 =
      s21_sprintf(s21_buff, "|%12.8f|%10.4f|%-10.2f|", 0.0000001f, 0.0f, 3.14f);
...
START_TEST(test23_s21_sprintf_float_flags) {
  ...
  int s21_res3 =
      s21_sprintf(s21_buff, "|%-10f|%-12f|% -10f|", 3.14f, -3.14f, 3.00f);
