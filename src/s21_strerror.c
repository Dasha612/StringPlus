...
char *s21_strerror(int errnum) {
  ...
  static const struct error_info macos_errors = {
      .max_err = 106,
      .descriptions = {[0] = "Undefined error: 0",
                       [1] = "Operation not permitted",
                       [2] = "No such file or directory",
                       [3] = "No such process",
                       ...
                       [71] = "Bad RPC struct",
                       [72] = "RPC version wrong",
                       [73] = "RPC prog. not avail.",
                       [74] = "Program version wrong",
                       [75] = "Bad procedure for program",
                       [76] = "No locks available",
                       [77] = "Function not implemented",
                       [78] = "Inappropriate file type or format",
                       [79] = "Authentication error",
                       [80] = "Need authenticator",
                       [81] = "Device power is off",
                       [82] = "Device error",
                       [83] = "Value too large to be stored in data type",
                       [84] = "Bad executable (or shared library)",
                       [85] = "Bad CPU type in executable",
                       [86] = "Shared library version mismatch",
                       [87] = "Malformed Mach-o file",
                       [88] = "Operation canceled",
                       [89] = "Identifier removed",
                       [90] = "No message of desired type",
                       [91] = "Illegal byte sequence",
                       [92] = "No attribute found",
                       [93] = "Bad message",
                       [94] = "Reserved",
                       [95] = "No message available",
                       [96] = "Reserved",
                       [97] = "No STREAM resources",
                       [98] = "Not a STREAM",
                       [99] = "Protocol error",
                       [100] = "STREAM ioctl() timeout",
                       [101] = "Operation not supported on socket",
                       [102] = "Policy not found",
